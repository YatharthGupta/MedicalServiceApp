...
export class ApiService {
  ...
  public getServices() {
    //  return this.httpClient.get(this.SERVICES_URL,{responseType  : 'text'}).pipe(catchError(this.handleError));
    ...
    // return fetch(this.SERVICES_URL, {
    //   method: 'GET'
  // });
  }

  public getProviders() {
    //return this.httpClient.get(this.PROVIDERS_URL).pipe(catchError(this.handleError));
